...
if (isset($_GET['id_service'])) {
    ...
    echo "L'identifiant du service à modifier n'a pas été spécifié.";
...
if ($result && $row = mysqli_fetch_assoc($result)) {
    ...
    echo "L'identifiant du service n'a pas été trouvé dans la base de données.";
    exit(); // Arrêtez le script pour éviter l'affichage du formulaire vide
}
?>
...
<head>
    ...
    <title>Modifier Service - Brand</title>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Modifier Service</h3>
                </div>
                            ...
                            <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-5">
                                <div class="card mb-7">
                                    <div class="card-body p-sm-5">
                                        <form  action="traitement_modification_service.php" method="post">
                                        <input type="hidden" name="id_service" value="<?php echo $row['id_service']; ?>">
                                        <label for="titre">Titre :</label>
                                        <textarea id="titre" class="form-control" name="titre" rows="6" placeholder="Titre" required><?php echo $row['libelle']; ?></textarea>
                                        <br>
                                        <br>
                                        <label for="libelle">Libellé :</label>
                                        <textarea id="libelle" class="form-control" name="libelle" rows="6" placeholder="Libellé" required><?php echo $row['libelle']; ?></textarea>
                                        <br>
                                        <br>
                                        <button class="btn btn-primary d-block w-100" name="modifier_service" type="submit">Modifier</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
