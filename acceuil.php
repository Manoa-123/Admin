        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">ACCEUIL</h3>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                ...
                                <?php
                                    ...
                                    $sql_acceuil = mysqli_query($conn,$sql);
                                    if ($sql_acceuil -> num_rows > 0) {
                                        echo '<echo>
                                        <thead>
                                            <tr>
                                                <th>Id</th>
                                        ...
                                        while ($row_acceuil = mysqli_fetch_assoc($sql_acceuil)) {
                                            # code...
                                            echo '<tbody>
                                                <tr>
                                                    <td>'.$row_acceuil['id_acceuil'].'</td>
                                                    <td>'.$row_acceuil['libelle_1'].'</td>
                                                    <td>'.$row_acceuil['libelle_2'].'</td>
                                                    <td>'.$row_acceuil['libelle_3'].'</td>
                                                    <td>'.$row_acceuil['libelle_4'].'</td>
                                                    ...
                                                    <a href="delete_acceuil.php?id_acceuil=' . $row_acceuil['id_acceuil'] . '">
                                                    ...
                                                    <a href="modifier_acceuil.php?id_acceuil=' . $row_acceuil['id_acceuil'] . '">
