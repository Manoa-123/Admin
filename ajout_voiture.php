        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: var(--bs-red);">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="profile.php"><i class="fas fa-user"></i><span>PROFILES</span></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Ajout de voiture</h3>
                </div>
                            ...
                            <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-5">
                                <div class="card mb-7">
                                    <div class="card-body p-sm-5">
                                        <form  action="traitement_ajoutvoiture.php" method="post"enctype="multipart/form-data">
                                        <input type="text" id="name-2" name="voiture_marque" placeholder="marque">
                                                <br>
                                                <br>
                                        <input type="text" id="name-2" name="voiture_name" placeholder="nom voiture">
                                                <br>
                                                <br>
                                                <input type="text" id="name-2" name="voiture_transmission" placeholder="transmission">
                                                <br>
                                                <br>
                                        <input type="text" id="name-2" name="voiture_carburant" placeholder="carburant">
                                                <br>
                                                <br>
                                        <input type="text" id="name-2" name="voiture_type" placeholder="type">
                                                <br>
                                                <br>
                                                <input type="text" id="name-2" name="voiture_km" placeholder="km">
                                                <br>
                                                <br>
                                        <input type="text" id="name-2" name="voiture_puissance" placeholder="puissance">
                                                <br>
                                                <br>
                                                <input type="text" id="name-2" name="voiture_annee" placeholder="année">
                                                <br>
                                                <br>
                                        
                                                <input type="text" id="name-2" name="voiture_prix" placeholder="prix">
                                                <br>
                                                <br>
                                        <input type="text" id="name-2" name="provenance" placeholder="provenance">
                                                <br>
                                                <br>

                                                
                                    <input type="file" name="image[]" accept="image/*" multiple >
                                    <input type="submit" name="submit" value="Envoyer les images">
