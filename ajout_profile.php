        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Ajout de profil</h3>
                </div>
                            ...
                            <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-5">
                                <div class="card mb-7">
                                    <div class="card-body p-sm-5">
                                        <form  action="traitement_ajoutprofil.php" method="post">
                                        <input type="text" id="name-2" name="username" placeholder="username">
                                                <br>
                                                <br>
                                        <input type="text" id="name-2" name="mdp" placeholder="mot de passe">
                                                <br>
                                                <br>
