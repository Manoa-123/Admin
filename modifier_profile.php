...
if (isset($_GET['id_admin'])) {
    ...
    echo "L'identifiant à modifier n'a pas été spécifié.";
...
if ($result && $row = mysqli_fetch_assoc($result)) {
    ...
    echo "L'identifiant n'a pas été trouvé dans la base de données.";
    exit(); // Arrêtez le script pour éviter l'affichage du formulaire vide
}
?>
...
<head>
    ...
    <title>Modifier Profile - Brand</title>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Modifier Profile</h3>
                </div>
                            ...
                            <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-5">
                                <div class="card mb-7">
                                    <div class="card-body p-sm-5">
                                        <form  action="traitement_modification_profile.php" method="post">
                                        <input type="hidden" name="id_admin" value="<?php echo $row['id_admin']; ?>">
                                        <label for="username">username :</label>
                                        <textarea id="username" class="form-control" name="username" rows="6" placeholder="username" required><?php echo $row['username']; ?></textarea>
                                        <br>
                                        <br>
                                        <label for="mot de passe">mot de passe :</label>
                                        <textarea id="mdp" class="form-control" name="mdp" rows="6" placeholder="mdp" required><?php echo $row['mdp']; ?></textarea>
                                        <br>
                                        <br>
                                        <button class="btn btn-primary d-block w-100" name="modifier_profile" type="submit">Modifier</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
